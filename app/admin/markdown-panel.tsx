...
// Static component map — defined outside the component to avoid
// re-creating on every render (react-markdown compares references).
const mdComponents: Components = {
  ...
  code: ({ children, className }) => {
    // Block code: className contains "language-*" from react-markdown
  ...
  // Passthrough <pre> to avoid double nesting (code handler already wraps in <pre>)
